    ...
    return (
        <div className={style.blog_card_wrapper}>
            <div className={style.blog_card_container} style={cardStyle}>
                <Link className={style.blog_card_link} to={`/blog`}><h1 className={style.blog_card_title}>{articleTitle}</h1></Link>
                ...
                <div className={style.blog_card_info}>
                    ...
                    <Link className={style.blog_card_link} to={`/blog`} >Read More <FaAngleRight /></Link>
                </div>
            </div>
        </div>
    )
